...
const MainForm: React.FC<MainFormProps> = ({ categories, categoryNames, filteredPosts, category }) => {
  return (
    <div className="bg-slate-100 p-6">
      ...
      <div className="space-y-4">
        {filteredPosts.map((post) => (
          ...
          >
            <h2 className="text-xl font-bold mb-2 text-gray-800 hover:text-blue-600">{post.title}</h2>
            <p className="text-gray-600">{post.content}</p>
            <div className="mt-2 text-sm text-gray-500">
              <span>카테고리: {categoryNames[post.category]}</span>
